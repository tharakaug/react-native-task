...
const UploadScreen3 = () => {
  ...
  return (
    <View className="flex-1 bg-white px-4 pt-4">
      ...
      {/* Title */}
      <Text className="mt-5 mb-3 text-black">Add Image 3</Text>
      ...
      <View className="mb-6 flex-row justify-between">
        ...
        <Pressable className="rounded-xl bg-gray-300 py-4 px-6" onPress={() => router.push("/(dashboard)/home/observation") }>
